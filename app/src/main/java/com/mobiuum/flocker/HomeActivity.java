    ...
    private void setUpRecyclerView() {
        ...
        adapter.setRecyclerClickListener(new RecyclerAdapter.RecyclerClickListener() {
            ...
            public void onClick(int position) {
                if (position == 0) {
                    spaceNavigationView.showBadgeAtIndex(1, 54, ContextCompat.getColor(HomeActivity.this, R.color.badge_background_color));
                } else if (position == 1) {
